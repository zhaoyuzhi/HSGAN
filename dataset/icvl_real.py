...
class HS_multiscale_DSet(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # read an image
        rgbpath = os.path.join(self.opt.baseroot_train, 'generated_rgb_realworld', self.imglist[index] + '.png')
...
class HS_multiscale_ValDSet(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # read an image
        rgbpath = os.path.join(self.opt.baseroot_val, 'generated_rgb_realworld', self.imglist[index] + '.png')
